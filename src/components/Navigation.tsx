      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center transition-transform group-hover:scale-105">
              <span className="text-primary-foreground font-playfair font-bold text-xl">M</span>
            </div>
            <span className="font-playfair font-bold text-2xl text-primary">Medjool Star</span>
          </Link>

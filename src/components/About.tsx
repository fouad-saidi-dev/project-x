        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-foreground/80 leading-relaxed">
              <p>
                Lancée en 2013, Medjool Star est la filiale agricole du <strong>Groupe Saham</strong> spécialisée 
                dans la production et le conditionnement de dattes Mejhoul. Medjool Star opère la plus grande 
                ferme de palmiers dattiers au Maroc, située dans le berceau de la datte Mejhoul, dans la 
                province d'Errachidia.
              </p>
              <p>
                Medjool Star et l'ensemble de nos collaborateurs sont portés par la volonté de{" "}
          ...
          <div className="relative">
            <div className="rounded-lg overflow-hidden shadow-2xl">
              <img 
                src={farmImage} 
                alt="Medjool Star Farm Aerial View" 
